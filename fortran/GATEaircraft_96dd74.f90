...
module GATEaircraft_mod
  ...
  type :: GATE_aircraft_type
     ...
     real :: RADIATIVE_TEMPERATURE1
     real :: RADIATIVE_TEMPERATURE2
...
program GATEaircraft
  ...
  case ( "1" )
     ...
     if ( line(2:61) /= "(I1,I4,I10,I5,13(F7.0,F5.1,F5.1,F7.3,F7.3,F6.1,F6.0,F5.0,F5." ) then
        write ( * , * )
        write ( * , * ) trim(infile), ':'
...
110 format(I1,I4,I10,I5,13(F7.0,F5.1,F5.1,F7.3,F7.3,F6.1,F6.0,F5.0,F5.                  &
                           1,F6.2,F6.2,F5.1,F5.1,F6.1,F6.1,F5.1,F6.1,F6.1,F5.1,F5.1,F5. &
                           1,F5.1,F5.1,F5.1,F5.1), 93X)
