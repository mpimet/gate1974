...
module GATEaircraft_mod
  ...
  public :: GATE_aircraft_type, GATE_metadate_type
...
110 format(I1,I4,I10,I5,12(F6.0,F7.3,F8.3,F6.1,F5.2,F5.0,F5.1,F5.1,F5.2,F5.1, &
           F5.2,F5.1,F5.2,F5.1,F5.2,F5.1,F5.1,F5.1,F6.1,F6.1,F6.1,F6.1,F6.1,  &
           F6.1,18I1))
...
subroutine write_netcdf ( infile, no_of_measurements, aircraftdata, metadata )
  ...
  call handle_err(nf_put_att_text(ncid, std_altitude_id, "long_name", 30, "standard_deviation_of_altitude"))
