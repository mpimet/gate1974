...
module GATEaircraft_mod
  ...
  integer, parameter :: no_of_records_in_line = 9 ! see format string 110
  ...
  type :: GATE_aircraft_type
     ...
     real    :: ROLL
     real    :: LONG_RAD_DOWN4
     real    :: SHORT_RAD_DOWN1
     real    :: SHORT_RAD_DOWN2
     real    :: SHORT_RAD_DOWN3
     real    :: LONG_RAD_UP4
     real    :: LONG_RAD_UP1
     real    :: LONG_RAD_UP2
     real    :: LONG_RAD_UP3
...
use GATEaircraft_mod
  ...
  case ( "1" )
     ...
     if ( line(2:67) /= "(I1,I4,I10,I5,9(F6.0,F7.3,F8.3,F6.1,F5.2,F5.0,F5.1,F5.1,F5.2,F5.1," ) then
        write ( * , * )
        write ( * , * ) trim(infile), ':'
...
110 format(I1,I4,I10,I5,9(F6.0,F7.3,F8.3,F6.1,F5.2,F5.0,F5.1,F5.1,F5.2,F5.1,                &
                          F5.2,F5.1,F5.2,F5.1,F5.2,F5.1,F5.2,F5.1,F5.2,F5.1,F5.1,F5.1,F5.1, &
                          F5.1,F6.1,F6.1,F6.1,F6.1,F6.1,F6.1,F6.1,F6.1,23I1))
